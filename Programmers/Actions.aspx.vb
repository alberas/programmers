...
Public Class Actions
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Dim outStr As New Object()
        Try
            txtNumber = Double.Parse(Request("txtNumber"))
        ...
        If txtNumber = 0 Then
            ...
            Response.Write(JsonConvert.SerializeObject(outStr))
            Response.End()
        End If
        ...
        If (numBillion > 0) Then
            ...
            str.Add(WriteHundred(numBillion) & " Billion")
        ...
        If txtNumber > 1000000 Then
            ...
            str.Add(WriteHundred(numMillion) & " Million")
        ...
        If txtNumber >= 1000 Then
            ...
            str.Add(WriteHundred(numThousand) & " Thoudsand")
        ...
        If txtNumber >= 100 Then
            ...
            str.Add(WriteHundred(numHundred) & " Hundred")
            txtNumber = txtNumber - hundredPart
        End If


        If txtNumber >= 0 Then
            str.Add(WriteUnits(txtNumber))
            str.Add("Dollars")

            Dim dec As Integer = Math.Round(100 * (txtNumber - Integer.Parse(Math.Truncate(txtNumber))))
            If dec > 0 Then
                str.Add("And")
                str.Add(WriteUnits(dec) & " cents")
            End If
        End If


        outStr = New With {
            .strNumber = Strings.Join(str.ToArray, " ")
        }
        Response.Write(JsonConvert.SerializeObject(outStr))
        Response.End()
    End Sub
